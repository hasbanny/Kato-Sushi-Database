...
abstract class Supplier implements ActiveRecordInterface
{
    ...
    /**
     * The value for the sup_id field.
     *
     * @var        int
     */
    protected $sup_id;
    ...
    public function setSupId($v)
    {
        ...
        if ($this->sup_id !== $v) {
            $this->sup_id = $v;
            $this->modifiedColumns[SupplierTableMap::COL_SUP_ID] = true;
        }
    ...
    public function setPhoneNum($v)
    {
        ...
        if ($this->phone_num !== $v) {
            $this->phone_num = $v;
            $this->modifiedColumns[SupplierTableMap::COL_PHONE_NUM] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SupplierTableMap::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sup_id = (null !== $col) ? (int) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SupplierTableMap::COL_SUP_ID)) {
            $modifiedColumns[':p' . $index++]  = 'sup_id';
        }
        ...
        if ($this->isColumnModified(SupplierTableMap::COL_PHONE_NUM)) {
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'sup_id':
                        $stmt->bindValue($identifier, $this->sup_id, PDO::PARAM_INT);
                        break;
                    case 'name':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SupplierTableMap::COL_SUP_ID)) {
            $criteria->add(SupplierTableMap::COL_SUP_ID, $this->sup_id);
        }
        if ($this->isColumnModified(SupplierTableMap::COL_NAME)) {
        ...
        if ($this->isColumnModified(SupplierTableMap::COL_PHONE_NUM)) {
            $criteria->add(SupplierTableMap::COL_PHONE_NUM, $this->phone_num);
        }
    ...
    /**
     * Generic method to set the primary key (sup_id column).
     *
