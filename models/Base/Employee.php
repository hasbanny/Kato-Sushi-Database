...
abstract class Employee implements ActiveRecordInterface
{
    ...
    public function setEmpSsn($v)
    {
        ...
        if ($this->emp_ssn !== $v) {
            $this->emp_ssn = $v;
            $this->modifiedColumns[EmployeeTableMap::COL_EMP_SSN] = true;
        }
    ...
    public function setPhoneNum($v)
    {
        ...
        if ($this->phone_num !== $v) {
            $this->phone_num = $v;
            $this->modifiedColumns[EmployeeTableMap::COL_PHONE_NUM] = true;
        }
    ...
    public function setJobTitle($v)
    {
        ...
        if ($this->job_title !== $v) {
            $this->job_title = $v;
            $this->modifiedColumns[EmployeeTableMap::COL_JOB_TITLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EmployeeTableMap::translateFieldName('Salary', TableMap::TYPE_PHPNAME, $indexType)];
