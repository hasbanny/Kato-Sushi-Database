...
/**
 * Base class that represents a row from the 'owner' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Owner implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OwnerTableMap';
    ...
    /**
     * Compares this with another <code>Owner</code> instance.  If
     * <code>obj</code> is an instance of <code>Owner</code>, delegates to
     * <code>equals(Owner)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Owner The current object, for fluid interface
     */
    ...
    public function setOwnerId($v)
    {
        ...
        if ($this->owner_id !== $v) {
            $this->owner_id = $v;
            $this->modifiedColumns[OwnerTableMap::COL_OWNER_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[OwnerTableMap::COL_NAME] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[OwnerTableMap::COL_ADDRESS] = true;
        }
    ...
    public function setPhoneNum($v)
    {
        ...
        if ($this->phone_num !== $v) {
            $this->phone_num = $v;
            $this->modifiedColumns[OwnerTableMap::COL_PHONE_NUM] = true;
        }
    ...
    public function setPasswordHash($v)
    {
        ...
        if ($this->password_hash !== $v) {
            ...
            $this->modifiedColumns[OwnerTableMap::COL_PASSWORD_HASH] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OwnerTableMap::translateFieldName('OwnerId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->owner_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OwnerTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OwnerTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OwnerTableMap::translateFieldName('PhoneNum', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_num = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OwnerTableMap::translateFieldName('PasswordHash', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = OwnerTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Owner'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOwnerQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOwnerQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OwnerTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OwnerTableMap::COL_OWNER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'owner_id';
        }
        if ($this->isColumnModified(OwnerTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(OwnerTableMap::COL_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'address';
        }
        if ($this->isColumnModified(OwnerTableMap::COL_PHONE_NUM)) {
            $modifiedColumns[':p' . $index++]  = 'phone_num';
        }
        if ($this->isColumnModified(OwnerTableMap::COL_PASSWORD_HASH)) {
            $modifiedColumns[':p' . $index++]  = 'password_hash';
        }

        $sql = sprintf(
            'INSERT INTO owner (%s) VALUES (%s)',
    ...
    {
        $pos = OwnerTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Owner'][$this->hashCode()] = true;
        $keys = OwnerTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OwnerTableMap::COL_OWNER_ID)) {
            $criteria->add(OwnerTableMap::COL_OWNER_ID, $this->owner_id);
        }
        if ($this->isColumnModified(OwnerTableMap::COL_NAME)) {
            $criteria->add(OwnerTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(OwnerTableMap::COL_ADDRESS)) {
            $criteria->add(OwnerTableMap::COL_ADDRESS, $this->address);
        }
        if ($this->isColumnModified(OwnerTableMap::COL_PHONE_NUM)) {
            $criteria->add(OwnerTableMap::COL_PHONE_NUM, $this->phone_num);
        }
        if ($this->isColumnModified(OwnerTableMap::COL_PASSWORD_HASH)) {
            $criteria->add(OwnerTableMap::COL_PASSWORD_HASH, $this->password_hash);
        }
    ...
    {
        $criteria = ChildOwnerQuery::create();
        $criteria->add(OwnerTableMap::COL_OWNER_ID, $this->owner_id);
    ...
    /**
     * Generic method to set the primary key (owner_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Owner (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Owner Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OwnerTableMap::DEFAULT_STRING_FORMAT);
    }
