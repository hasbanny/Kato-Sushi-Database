 ...
 */
abstract class Finances implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\FinancesTableMap';
    ...
    /**
     * Initializes internal state of Base\Finances object.
     */
    ...
    /**
     * Compares this with another <code>Finances</code> instance.  If
     * <code>obj</code> is an instance of <code>Finances</code>, delegates to
     * <code>equals(Finances)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Finances The current object, for fluid interface
     */
    ...
    public function setInvoices($v)
    {
        ...
        if ($this->invoices !== $v) {
            $this->invoices = $v;
            $this->modifiedColumns[FinancesTableMap::COL_INVOICES] = true;
        }
    ...
    public function setBills($v)
    {
        ...
        if ($this->bills !== $v) {
            $this->bills = $v;
            $this->modifiedColumns[FinancesTableMap::COL_BILLS] = true;
        }
    ...
    public function setPayroll($v)
    {
        ...
        if ($this->payroll !== $v) {
            $this->payroll = $v;
            $this->modifiedColumns[FinancesTableMap::COL_PAYROLL] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(FinancesTableMap::DATABASE_NAME);
        }

        // We don't need to alter the object instance pool; we're just modifying this instance
        // already in the pool.

        $dataFetcher = ChildFinancesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Finances::setDeleted()
     * @see Finances::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildFinancesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                FinancesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FinancesTableMap::COL_INVOICES)) {
            $modifiedColumns[':p' . $index++]  = 'invoices';
        }
    ...
    {
        $pos = FinancesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Finances'][$this->hashCode()] = true;
        $keys = FinancesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(FinancesTableMap::DATABASE_NAME);

        if ($this->isColumnModified(FinancesTableMap::COL_INVOICES)) {
            $criteria->add(FinancesTableMap::COL_INVOICES, $this->invoices);
        }
        if ($this->isColumnModified(FinancesTableMap::COL_BILLS)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Finances (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Finances Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(FinancesTableMap::DEFAULT_STRING_FORMAT);
    }
