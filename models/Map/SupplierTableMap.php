...
class SupplierTableMap extends TableMap
{
    ...
    /**
     * the column name for the sup_id field
     */
    const COL_SUP_ID = 'supplier.sup_id';
     ...
     */
    const COL_PHONE_NUM = 'supplier.phone_num';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('SupId', 'Name', 'Address', 'PhoneNum', ),
        self::TYPE_CAMELNAME     => array('supId', 'name', 'address', 'phoneNum', ),
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_SUP_ID, SupplierTableMap::COL_NAME, SupplierTableMap::COL_ADDRESS, SupplierTableMap::COL_PHONE_NUM, ),
        self::TYPE_FIELDNAME     => array('sup_id', 'name', 'address', 'phone_num', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('SupId' => 0, 'Name' => 1, 'Address' => 2, 'PhoneNum' => 3, ),
        self::TYPE_CAMELNAME     => array('supId' => 0, 'name' => 1, 'address' => 2, 'phoneNum' => 3, ),
        self::TYPE_COLNAME       => array(SupplierTableMap::COL_SUP_ID => 0, SupplierTableMap::COL_NAME => 1, SupplierTableMap::COL_ADDRESS => 2, SupplierTableMap::COL_PHONE_NUM => 3, ),
        self::TYPE_FIELDNAME     => array('sup_id' => 0, 'name' => 1, 'address' => 2, 'phone_num' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array (
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function getPrimaryKeyFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        return (int) $row[
            $indexType == TableMap::TYPE_NUM
                ? 0 + $offset
                : self::translateFieldName('SupId', TableMap::TYPE_PHPNAME, $indexType)
        ];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SupplierTableMap::COL_SUP_ID);
            $criteria->addSelectColumn(SupplierTableMap::COL_NAME);
            $criteria->addSelectColumn(SupplierTableMap::COL_ADDRESS);
            $criteria->addSelectColumn(SupplierTableMap::COL_PHONE_NUM);
        } else {
            $criteria->addSelectColumn($alias . '.sup_id');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SupplierTableMap::COL_SUP_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(SupplierTableMap::COL_SUP_ID) && $criteria->keyContainsValue(SupplierTableMap::COL_SUP_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.SupplierTableMap::COL_SUP_ID.')');
        }
